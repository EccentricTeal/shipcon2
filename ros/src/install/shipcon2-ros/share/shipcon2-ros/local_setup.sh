...
: ${AMENT_CURRENT_PREFIX:="/media/suisei/Data/data/projects/shipcon2/ros/src/install/shipcon2-ros"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/shipcon2-ros/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/shipcon2-ros/environment/path.sh"
